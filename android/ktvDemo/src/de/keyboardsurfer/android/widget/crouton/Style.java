...
public class Style {
  ...
  public static final int holoGreenLight = 0xff008080;//0xff99cc00;
  ...
  static {
    ALERT = new Builder()
      .setBackgroundColorValue(holoRedLight).setTextColorValue(yellow)
      .build();
    CONFIRM = new Builder()
      .setBackgroundColorValue(holoGreenLight).setTextColorValue(yellow)
      .build();
    INFO = new Builder()
      .setBackgroundColorValue(holoBlueLight).setTextColorValue(yellow)
      .build();
  }
