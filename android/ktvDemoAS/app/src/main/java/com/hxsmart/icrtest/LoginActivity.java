...
public class LoginActivity extends Activity {
	...
	private static final boolean isHideCompanyName = false;//是否隐藏 【公司名称】
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        CloseSocketBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				CloseSocketBtn.setVisibility(View.INVISIBLE);
				socket.socketClose();
				loadingLog.setText("has disconnected!");
			}
		});
        ...
        connectBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				{
					loadingLog.setText("Already connected, cannot be reconnect!\n Please disconnect the previous connection");
        ...
        handler = new Handler(){
			...
			public void handleMessage(Message msg) {
				...
				if(msg.what==520)
				{
					loadingLog.setText("connect success！");
					connectBtn.setVisibility(View.VISIBLE);
					clearFlagBtn.setVisibility(View.VISIBLE);
					...
					loadingLog.setText("connect fail！"+/*(String)msg.obj*/"We can do it again！");
					connectBtn.setVisibility(View.VISIBLE);
					clearFlagBtn.setVisibility(View.VISIBLE);
	...
	private void execFunction()
	{
		...
		PreviewBtn.setVisibility(View.INVISIBLE);
        settingBtn.setVisibility(View.INVISIBLE);
		loadingLog.setText("connecting...");
		loadingLog.setText("setup socket...");
		startConnectThread();
	}
	...
	protected void onResume() {
		Log.i("zbh", "onResume");
		loadingLog.setText("Welcome to palm 2010S");
		IP = sharedpreferences.getString(KEY_IP, "192.168.11.254");
		if(!isHideCompanyName)
			Crouton.makeText(this, "Guangzhou spectrum Photoelectric Technology Co., Ltd.", Style.CONFIRM, R.layout.activity_splash).show();
		super.onResume();
	}
