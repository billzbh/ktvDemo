      ...
      //设置无标题  
        ...
        resetButton.setOnClickListener(new android.view.View.OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				.setTitle("Warning").setIcon(android.R.drawable.ic_dialog_info)
				.setMessage("Do you want all PushRods of this page to be reset?")
        ...
        resetButton.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View arg0) {
				new AlertDialog.Builder(WorkingActivity.this)
				.setTitle("Warning").setIcon(android.R.drawable.ic_dialog_info)
				.setMessage("Do you want all PushRods of these pages to be reset?")
				.setPositiveButton("OK", new OnClickListener() {
...
//				System.out.println();
        ...
        pager.setOnPageChangeListener(new OnPageChangeListener() {
            ...
            public void onPageScrollStateChanged(int arg0) {
            	...
            	//TODO 是否为触摸模式
            	if(mode_tv.getText().equals("Touch"))
            	{
            		if(isDOWN3)
                	{
                		count = 0;
...
//				updateAllseekbar();
		...
		wheelG.setOnLongClickListener(new OnWheelLongPressListener() {
			...
			public void onItemLongPressed(View Textview, final int itemIndex) {
				...
				new AlertDialog.Builder(WorkingActivity.this)
				.setTitle("input new flag").setIcon(android.R.drawable.ic_dialog_info)
				.setView(et)
				.setPositiveButton("OK", new OnClickListener() {
