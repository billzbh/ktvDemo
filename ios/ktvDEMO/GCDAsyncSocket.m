...
+ (GCDAsyncSocket *)sharedController
{
    static dispatch_once_t onceToken;
    static GCDAsyncSocket *sg_GCDAsyncSocket;
    dispatch_once(&onceToken, ^{
        sg_GCDAsyncSocket = [[GCDAsyncSocket alloc] initWithDelegate:nil delegateQueue:dispatch_get_main_queue()];
    });
    return sg_GCDAsyncSocket;
}
...
//    int on = 1;
//    if (setsockopt(socketFD, IPPROTO_TCP, TCP_NODELAY, (char*)&on, sizeof(on)) == -1) {
//        /* handle error */
//        if (errPtr)
//            *errPtr = [self errnoErrorWithReason:@"Error in setsockopt TCP_NODELAY"];
//        
//        return NO;
//    }
